...
- еженедельная отправка таблицы дежурств на следующую неделю из Grafana OnCall (если секция `oncall` настроена), иначе из локального `[schedule]`;
...
weekends_alerts = true # если false, в недельной таблице скрываются суббота и воскресенье
