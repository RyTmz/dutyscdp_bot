...
Чтобы вручную запустить весь ежедневный сценарий (получение текущих дежурных, синхронизация состава duty‑группы в Loop и отправка уведомления в чат), отправьте POST-запрос на `/oncall_duty` без тела или с пустым JSON.
